...
class TranscodingSettings(BaseModel):
    ...
    preset: Optional[str] = None  # Encoding preset (-preset)
    tune: Optional[str] = None  # Encoding tuning (-tune)
    r: Optional[Union[str, int]] = None  # Frame rate (-r)
    s: Optional[str] = None  # Resolution (-s)
    b__v: Optional[str] = None  # Video bitrate (-b:v)
    b__a: Optional[str] = None  # Audio bitrate (-b:a)
    vf: Optional[str] = None  # Video filters (-vf)
    af: Optional[str] = None  # Audio filters (-af)
    map: Optional[str] = None  # Stream mapping (-map)
    ss: Optional[str] = None  # Start time offset (-ss)
    t: Optional[str] = None  # Recording time (-t)
    crf: Optional[Union[str, int]] = None  # Constant rate factor (-crf)
    maxrate: Optional[Union[str, int]] = None  # Maximum bitrate (-maxrate)
    bufsize: Optional[Union[str, int]] = None  # Buffer size (-bufsize)
